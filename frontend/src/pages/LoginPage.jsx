      ...
      <div className="w-full max-w-md p-8 sm:p-10 bg-slate-900 border border-slate-800 rounded-2xl shadow-xl">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="px-2 text-slate-500 bg-slate-900">Or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center justify-center w-full p-3.5 space-x-2.5 font-medium text-slate-300 transition-colors border border-slate-800 rounded-xl bg-slate-950 hover:bg-slate-900 disabled:opacity-50 disabled:cursor-not-allowed"
        >
