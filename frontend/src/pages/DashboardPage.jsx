  ...
  return (
    <div className="min-h-screen p-10 text-white bg-slate-950">
      ...
      <div className="space-y-3">
        ...
        {/* NEW WORK: High-glance dashboard row container linking to full view */}
        <div className="grid max-w-4xl grid-cols-1 mt-8">
          <div 
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-200">View Upcoming Meetings</h3>
